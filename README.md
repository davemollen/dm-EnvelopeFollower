...
This is a CV Enveloper Follower plugin written in Rust.
...
You can download the LV2 plugins from the [releases page](https://github.com/davemollen/dm-EnvelopeFollower/releases).
...
The latest MOD builds can also be found on the [releases page](https://github.com/davemollen/dm-EnvelopeFollower/releases).
